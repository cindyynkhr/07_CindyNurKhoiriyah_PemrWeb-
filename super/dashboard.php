...
<body>
    ...
    btn.addEventListener('click', function(e) {
        ...
        document.querySelectorAll('.collapse').forEach(function(dropdown) {
        ...
        dropdownContainer.style.display = dropdownContainer.style.display === 'none' || dropdownContainer.style.display === '' 
            ? 'block' 
            : 'none';
        dropdownContainer.classList.toggle('show');

        // Hapus highlight dari semua menu utama
        document.querySelectorAll('.dropdown-btn').forEach(function(menu) {
            menu.classList.remove('active-menu');
        });

        // Tambahkan highlight hanya jika submenu tidak aktif
...
document.querySelectorAll('.collapse a').forEach(function(submenu) {
    submenu.addEventListener('click', function() {
        // Hapus highlight dari semua submenu
        document.querySelectorAll('.collapse a').forEach(function(item) {
            item.classList.remove('active-submenu');
        });

        // Tambahkan highlight ke submenu yang diklik
