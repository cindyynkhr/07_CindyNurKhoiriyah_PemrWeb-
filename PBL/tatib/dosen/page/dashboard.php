      ...
      <div class="card-body">
        <div class="row">
          <div class="col-4 text-end align-self-center">
            <i class="fas fa-arrow-up fa-2x" STYLE="color: #17A2B8;  background-color: rgba(23, 162, 184, 0.25) ; border-radius: 50%; width: 50px; height: 50px; display: inline-flex; justify-content: center; align-items: center; font-size: 24px;"></i>
          </div>
          <div class="col-8">
  ...
  <div class="col-md-3">
    <div class="card py-2">
      <div class="card-body">
        <div class="row">
          <div class="col-4 text-end align-self-center">
            <i class="bi bi-arrow-repeat bi-2x" STYLE="color: #FFC107;  background-color: rgba(255, 193, 7, 0.25) ; border-radius: 50%; width: 50px; height: 50px; display: inline-flex; justify-content: center; align-items: center; font-size: 24px;"></i>
          </div>
          <div class="col-8">
            <h5 class="card-title fw-semibold" style="font-size: 28px">234</h5>
            <p class="card-text fw-semibold" style="font-size: 16px; color: #b1b1b1">Total Pelanggaran</p>
  ...
  <div class="col-md-3">
    <div class="card py-2">
      <div class="card-body">
        <div class="row">
          <div class="col-4 text-end align-self-center">
            <i class="bi bi-arrow-repeat bi-2x" STYLE="color: #28A745;  background-color: rgba(255, 193, 7, 0.25) ; border-radius: 50%; width: 50px; height: 50px; display: inline-flex; justify-content: center; align-items: center; font-size: 24px;"></i>
          </div>
          <div class="col-8">
            <h5 class="card-title fw-semibold" style="font-size: 28px">234</h5>
            <p class="card-text fw-semibold" style="font-size: 16px; color: #b1b1b1">Total Pelanggaran</p>
