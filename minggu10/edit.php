        ...
        ?>
         <div class="container">
            ...
            <form action="proses.php?aksi=ubah" method="post">
                <input type="hidden" name="id" value="<?php echo $row['id'];?>"> 
                <label for="nama">Nama:</label>
                <input for="text" name="nama" id="nama" value="<?php echo $row ['nama']; ?>" required>
                <label for="jenis_kelamin">Jenis Kelamin:</label>
                <div class="radio-groub">
                    <input type="radio" name="jenis_kelamin" value="L" id="Laki" <?php if ($row['jenis_kelamin']==='L') echo 'checked';?> requires><label for="laki">Laki-laki</label>
                    <input type="radio" name="jenis_kelamin" value="P" id="perempuan" <?php if ($row['jenis_kelamin']==='P') echo 'checked';?> requires><label for="perempuan">Perempuan</label>
                </div>
                <label for="alamat">Alamat:</label>
